...
![RViz visualization showing VSLAM trajectory (yellow path), coordinate axes, and camera pose](../../../static/img/module-3/screenshots/rviz-vslam-trajectory.png)
...
- **Reduce motion speed**: Limit robot velocity to <1 m/s
