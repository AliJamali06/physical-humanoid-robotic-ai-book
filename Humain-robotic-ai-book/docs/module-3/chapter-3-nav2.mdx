...
Cost map visualization showing static obstacles (black), inflated regions (gray gradient), and free space (white) would be displayed here.
:::
...
**Use case**: Small maps (under 50m × 50m), when computation time is not critical
